...
After "signing up" as an anonymous user, you can [retrieve the "UserInfo" object](../user-management/user-profile/#userinfo-endpoint) and see the `sub` of the end-user.
