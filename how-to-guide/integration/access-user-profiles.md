...
To access any of the applications in your Authgear account, each user must have a profile in the account. [User Profiles](../user-management/user-profile/) contain information about your users such as name, contact information, and [standard](../user-management/user-profile/#standard-attributes) and[ custom attributes](../user-management/user-profile/#custom-attributes) you define. You can retrieve and manage user profiles in the following ways:
